...
open class synStack(private val activity: SingleActivity):IFragmentStack {
    val fragmentBackStack = CopyOnWriteArrayList<Fragment>()
    private val fragmentManager = activity.supportFragmentManager
    private val mainFragmentID = activity.mainFragmentID

    companion object{
        private const val TAG = "synStack"
    }
    ...
    override fun pop():Fragment {
        ...
        val result = fragmentBackStack.removeLast()
        replaceFragment(peek())
